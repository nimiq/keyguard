class Key {
     ...
     * @param {typeof Nimiq.Address} recipient Address of the transaction receiver
     ...
     * @returns {typeof Nimiq.Transaction} A prepared and signed Transaction object. This still has to be sent to the network.
     */
