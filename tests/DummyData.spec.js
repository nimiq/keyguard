...
Dummy.keyRecords = () => [
    ...
    Object.assign({}, Dummy.keyInfoObjects[1], { secret: new Uint8Array(_purposeIdArray.concat(Array.from(Dummy.keys[1]))), hash: Dummy.hashes()[1] }),
];

/** @type {() => StoredKeyRecord[]} */
Dummy.storedKeyRecords = () => Dummy.keyRecords().map( /** @param {KeyRecord} x; @param {number} i */(x, i) => Object.assign({}, x, { id: i }));
