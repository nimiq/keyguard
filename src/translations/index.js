const TRANSLATIONS = {
    en: {
        ...
        'passphrasebox-password-strength-weak': 'Hm, that\'s a weak password :(',
        'passphrasebox-password-strength-good': 'Ok, that\'s an average password.',
        'passphrasebox-password-strength-strong': 'Great, that\'s a strong password!',
        'passphrasebox-password-strength-secure': 'Super, that\'s a secure password!',
    ...
    de: {
        ...
        'passphrasebox-password-strength-weak': 'Hm, das ist ein schwaches Passwort :(',
