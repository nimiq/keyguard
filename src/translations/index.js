const TRANSLATIONS = {
    en: {
        ...
        'passphrasebox-password-strength-4': 'Hm, that\'s a weak password :(',
        'passphrasebox-password-strength-8': 'Ok, that\'s an average password.',
        'passphrasebox-password-strength-10': 'Great, that\'s a strong password!',
        'passphrasebox-password-strength-12': 'Super, that\'s a secure password!',
    ...
    de: {
        ...
        'passphrasebox-password-strength-4': 'Hm, das ist ein schwaches Passwort :(',
        'passphrasebox-password-strength-8': 'Ok, das ist ein gutes Passwort!',
        'passphrasebox-password-strength-10': 'Gut, das ist ein starkes Passwort!',
        'passphrasebox-password-strength-12': 'Super, das ist ein sicheres Passwort!',
