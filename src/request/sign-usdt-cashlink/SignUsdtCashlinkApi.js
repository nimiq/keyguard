...
class SignUsdtCashlinkApi extends PolygonRequestParserMixin(TopLevelApi) { // eslint-disable-line no-unused-vars
    ...
    async parseRequest(request) {
        ...
        parsedRequest.cashlinkMessage = this.parseMessage(request.cashlinkMessage);
        ...
        if (forwardRequest.to !== CONFIG.BRIDGED_USDT_TRANSFER_CONTRACT_ADDRESS &&
            forwardRequest.to !== '0x3c870b039bf82d2f883b6e89d41d06d26b9f4486') {
            throw new Errors.InvalidRequestError('USDT cashlink must use BRIDGED_USDT_TRANSFER_CONTRACT_ADDRESS or the new cashlink contract');
        }
