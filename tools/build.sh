...
echo "$nimiq_pow_hashsums" | ${SHA256SUM} --check --strict
...
echo "$nimiq_pos_hashsums" | ${SHA256SUM} --check --strict
...
echo "$bitcoinjs_hashsum" | ${SHA256SUM} --check --strict
...
echo "$ethersjs_hashsum" | ${SHA256SUM} --check --strict
...
echo "$nodeforge_hashsum" | ${SHA256SUM} --check --strict
